...
----
    ...
    public class com.oldcode.annotation.AppConfig { }
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
.Kotlin
----
	@Configuration
	@PropertySource("classpath:application.properties")
	class com.oldcode.annotation.AppConfig
----
...
The preceding `com.oldcode.annotation.AppConfig` class is equivalent to the following Spring `<beans/>` XML:
...
----
	public static void main(String[] args) {
		ApplicationContext ctx = new AnnotationConfigApplicationContext(com.oldcode.annotation.AppConfig.class);
...
----
	...
	fun main() {
		val ctx = AnnotationConfigApplicationContext(com.oldcode.annotation.AppConfig::class.java)
...
----
	public static void main(String[] args) {
		...
		ctx.register(com.oldcode.annotation.AppConfig.class, OtherConfig.class);
...
----
	...
	fun main() {
		...
		ctx.register(com.oldcode.annotation.AppConfig::class.java, OtherConfig::class.java)
...
assuming that `com.oldcode.annotation.AppConfig` is declared within the `com.acme` package (or any package
...
----
	<web-app>
		...
		<context-param>
			...
			<param-value>com.acme.com.oldcode.annotation.AppConfig</param-value>
		</context-param>
...
----
	...
	@Configuration
	public class com.oldcode.annotation.AppConfig implements BaseConfig {
...
container. In this series examples, we create a `@Configuration` class named `com.oldcode.annotation.AppConfig` and
...
`@Configuration` annotation and processes the `@Bean` methods declared in `com.oldcode.annotation.AppConfig`
properly.
...
----
	<beans>
		...
		<bean class="com.acme.com.oldcode.annotation.AppConfig"/>
...
NOTE: In `system-test-config.xml` file, the `com.oldcode.annotation.AppConfig` `<bean/>` does not declare an `id`
...
----
	<beans>
		<!-- picks up and registers com.oldcode.annotation.AppConfig as a bean definition -->
		<context:component-scan base-package="com.acme"/>
		<context:property-placeholder location="classpath:/com/acme/jdbc.properties"/>
