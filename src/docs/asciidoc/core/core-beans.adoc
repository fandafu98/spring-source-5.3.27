...
----
    ...
    public class com.study.annotation.AppConfig { }
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
.Kotlin
----
	@Configuration
	@PropertySource("classpath:application.properties")
	class com.study.annotation.AppConfig
----
...
The preceding `com.study.annotation.AppConfig` class is equivalent to the following Spring `<beans/>` XML:
...
----
	public static void main(String[] args) {
		ApplicationContext ctx = new AnnotationConfigApplicationContext(com.study.annotation.AppConfig.class);
...
----
	...
	fun main() {
		val ctx = AnnotationConfigApplicationContext(com.study.annotation.AppConfig::class.java)
...
----
	public static void main(String[] args) {
		...
		ctx.register(com.study.annotation.AppConfig.class, OtherConfig.class);
...
----
	...
	fun main() {
		...
		ctx.register(com.study.annotation.AppConfig::class.java, OtherConfig::class.java)
...
assuming that `com.study.annotation.AppConfig` is declared within the `com.acme` package (or any package
...
----
	<web-app>
		...
		<context-param>
			...
			<param-value>com.acme.com.study.annotation.AppConfig</param-value>
		</context-param>
...
----
	...
	@Configuration
	public class com.study.annotation.AppConfig implements BaseConfig {
...
container. In this series examples, we create a `@Configuration` class named `com.study.annotation.AppConfig` and
...
`@Configuration` annotation and processes the `@Bean` methods declared in `com.study.annotation.AppConfig`
properly.
...
----
	<beans>
		...
		<bean class="com.acme.com.study.annotation.AppConfig"/>
...
NOTE: In `system-test-config.xml` file, the `com.study.annotation.AppConfig` `<bean/>` does not declare an `id`
...
----
	<beans>
		<!-- picks up and registers com.study.annotation.AppConfig as a bean definition -->
		<context:component-scan base-package="com.acme"/>
		<context:property-placeholder location="classpath:/com/acme/jdbc.properties"/>
