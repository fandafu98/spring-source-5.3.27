...
----
	@WebAppConfiguration
	@ContextHierarchy({
		@ContextConfiguration(classes = com.study.annotation.AppConfig.class),
...
----
	@ExtendWith(SpringExtension.class)
	// ApplicationContext will be loaded from "/com.study.annotation.AppConfig.groovy" and
	// "/TestConfig.groovy" in the root of the classpath
	@ContextConfiguration({"/com.study.annotation.AppConfig.groovy", "/TestConfig.Groovy"}) <1>
	class MyTest {
		// class body...
	}
----
...
----
	@ExtendWith(SpringExtension.class)
	// ApplicationContext will be loaded from com.study.annotation.AppConfig and TestConfig
	@ContextConfiguration(classes = {com.study.annotation.AppConfig.class, TestConfig.class}) // <1>
	class MyTest {
		// class body...
	}
----
