...
----
	@WebAppConfiguration
	@ContextHierarchy({
		@ContextConfiguration(classes = com.oldcode.annotation.AppConfig.class),
...
----
	@ExtendWith(SpringExtension.class)
	// ApplicationContext will be loaded from "/com.oldcode.annotation.AppConfig.groovy" and
	// "/TestConfig.groovy" in the root of the classpath
	@ContextConfiguration({"/com.oldcode.annotation.AppConfig.groovy", "/TestConfig.Groovy"}) <1>
	class MyTest {
		// class body...
	}
----
...
----
	@ExtendWith(SpringExtension.class)
	// ApplicationContext will be loaded from com.oldcode.annotation.AppConfig and TestConfig
	@ContextConfiguration(classes = {com.oldcode.annotation.AppConfig.class, TestConfig.class}) // <1>
	class MyTest {
		// class body...
	}
----
